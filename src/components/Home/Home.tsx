...
const sections = [
  ...
  },
  {
    title: (<div>
      ...
      <a
        href="https://hashnode.com/@ParasharI"
        target="_blank"
        rel="noopener noreferrer"
        className="text-[#74C0FC] cursor-pointer hover:text-blue-500"
      >
        HashNode
      </a>
    </div>),
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="w-32 md:w-36 lg:w-40 block hover:scale-105 transition"
    >
